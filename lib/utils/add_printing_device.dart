...
*/
/*
class AddNewPrintingDevice extends StatefulWidget {
  static const id = 'printing_device';

  @override
  _AddNewPrintingDeviceState createState() => _AddNewPrintingDeviceState();
}

class _AddNewPrintingDeviceState extends State<AddNewPrintingDevice>
    with Printing {
  var view = Provider.of<AddNewPrinterViewModel>(myContext!, listen: false);
        ...
        child: Column(
          children: [
            ...
            FutureBuilder<List<Printer>>(
              future: view.list(), // async work
              builder: (BuildContext context,
                  AsyncSnapshot<List<Printer>> snapshot) {
                printWrapped(snapshot.toString());
                view.info();
...
class AddPrintingDevice extends StatelessWidget {
  static var id = "AddPrintingDevice";

  const AddPrintingDevice({Key? key}) : super(key: key);
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //     _devices = [];
  //   });
  //   printerManager.startScan(const Duration(seconds: 15));
